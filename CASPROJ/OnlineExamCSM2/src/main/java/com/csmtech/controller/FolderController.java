			...
			if (totalRows > 1 && successCheck) {
				...
				for (int i = 1; i < totalRows; i++) {
					...
					for (int j = 0; j < 7; j++) {
						...
						que.setOption1(next3.getCell(1) == null ? "" : String.valueOf(next3.getCell(1)));
						// que.setOption1((next3.getCell(2)== null ? "" : "not null"));
						que.setOption2(next3.getCell(2) == null ? "" : String.valueOf(next3.getCell(2)));
						// que.setOption1((next3.getCell(3)== null ? "" : "not null"));
						que.setOption3(next3.getCell(3) == null ? "" : String.valueOf(next3.getCell(3)));
						// que.setOption1((next3.getCell(4)== null ? "" : "not null"));
						que.setOption4(next3.getCell(4) == null ? "" : String.valueOf(next3.getCell(4)));
						// que.setOption1((next3.getCell(5)== null ? "" : "not null"));
						que.setOption5(next3.getCell(5) == null ? "" : String.valueOf(next3.getCell(5)));
