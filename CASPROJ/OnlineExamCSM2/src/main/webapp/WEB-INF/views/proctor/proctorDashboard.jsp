            ...
            <div class="col-md-6">
                ...
                <c:forEach items="${examList}" var="exam" varStatus="status">
                    <div class="card bg-light blue-text-card mt-3">
                        <div class="card-body">
                            <h5 class="card-title">${not empty exam.subTestTakerName ? exam.subTestTakerName : 'N/A'}</h5>
                ...
                <p>End Time: ${configure.endTime}</p>
                                ...
                                <a href="./monitor?subtesttakerId=${configure.subTestTaker.subTestTakerId}"  class="btn btn-light custom-button float-right underline-text px-2 py-1">
                                    <i class="bi-play"></i> Monitor
                                </a>
                            
                            <button class="btn btn-light custom-button float-right underline-text px-2 py-1">
